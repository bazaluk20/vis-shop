...
<body
    class="d-flex flex-column {if $controller == 'MainController'}main_page{elseif $controller == 'CartController'}cart_page{else}other_page{/if}">
                    ...
                    <div class="container">
                        <div
                            ...
                            <form id="fn_search" class="fn_search_mob search d-md-flex"
                                action="{url_generator route='products'}">
                                <input class="fn_search search__input" type="text" name="keyword" value="{$keyword|escape}"
                                    aria-label="search" data-language="index_search" placeholder="{$lang->index_search}" />
                                ...
                                {if $c->visible && ($c->has_products || $settings->show_empty_categories)}
                                    ...
                                    <div class="footer__menu_item {if $c_count > 5}closed{else}opened{/if}">
                                        <a class="footer__menu_link"
                                            href="{url_generator route='category' url=$c->url}">{$c->name|escape}</a>
                                    </div>
                                {/if}
                            {/foreach}
                            {if $c_count > 5}
                                ...
                                <div class="subscribe_form__group">
                                    <div class="d-flex align-items-center ">
                                        <div class="form__group form__group--subscribe">
                                            ...
                                            <input class="form__input form__input_subscribe" aria-label="subscribe"
                                        ...
                                        <button class="form__button form__button--subscribe" type="submit"><span
                                                data-language="subscribe_button">{$lang->subscribe_button}</span></button>
                                    </div>
                    ...
                    <div
                        ...
                        <div class="f_col-md flex-md-first d-flex align-items-center copyright">
                            ...
                            <a href="https://okay-cms.com" rel="noreferrer" target="_blank"
                                title="OkayCms">{include file="svg.tpl" svgId="okaycms"}</a>
                        </div>
                    </div>
                </div>
            </div>
