                        ...
                        <div class="details_boxed__offer" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                            ...
                            <div class="d-flex align-items-end justify-content-between details_boxed__price--wrapper">
                                <div class="d-flex flex-wrap align-items-center details_boxed__price_amount">
                                    <div class="details_boxed__prices">
                                        ...
                                        <div class="fn_discount_wrapper">
                                            ...
                                            <b>
                                                {$product->variant->compare_price-$product->variant->price} {$currency->sign|escape}
                                ...
                                <div class="d-flex align-items-center details_boxed__buttons">
                                    ...
                                    {* Privat BTN *}
                                    <div class="fn_is_stock privat_oplata_chastynamy_btn hidden {if $product->variant->stock < 1} hidden-xs-up{/if}">
                                        <button class=" product-page__button button--blick" type="submit" data-language="product_add_cart">
                                            {$lang->privat_pp_title}
                                            <br>
                                            <span>
                                                {$lang->order_text_of} <span class="privat_oplata_chastynamy">0</span> {$currency->sign|escape} в {$lang->privat_title_3}
                                            </span>
                                        </button>
                                    </div>
                                </div>
