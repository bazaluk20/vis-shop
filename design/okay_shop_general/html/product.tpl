...
<div class="fn_product block" itemscope itemtype="http://schema.org/Product">
    {* The product name *}
    <div
        class="block__header block__header--boxed block__header--border  {if $product->variant->sku}block__header--promo{/if}">
        ...
        <div class="block__header_promo product-page__sku{if !$product->variant->sku} hidden{/if}">
            ...
            <span class="fn_sku sku_nubmer" {if $product->variant->sku}itemprop="sku"
                {/if}>{$product->variant->sku|escape}</span>
        </div>
        ...
        <div class="hidden-desctop">
            <div class="details_boxed__rating">
                <div id="product_{$product->id}" class="product__rating fn_rating"
                    data-rating_post_url="{url_generator route='ajax_product_rating'}" {if $product->rating > 0}
                    itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating" {/if}>
                    ...
                    {if $product->rating > 0}
                        ...
                        <span class="rating_text rating_custom_text"> <span
                                itemprop="ratingValue">{$product->rating|string_format:"%.1f"}</span>/5</span>
    ...
    <div class="fn_transfer f_row flex-column flex-lg-row align-items-lg-stretch">
                                    ...
                                    <a href="{$image->filename|resize:1800:1800:w}" data-fancybox="we2" class="swiper-slide">
                                        <picture>
                                            ...
                                            <img {if $image@first} itemprop="image" {/if}
                                                src="{$image->filename|resize:700:800}" alt="{$product->name|escape}"
        ...
        <div class="block product-page__details f_col f_col-lg-5 f_col-xl-5">
                        ...
                        <div class="details_boxed__select">
                            ...
                            <select name="variant"
                                ...
                                <div class="details_boxed__offer" itemprop="offers" itemscope=""
                                    ...
                                    <div class="d-flex align-items-end justify-content-between details_boxed__price--wrapper">
                                        <div class="d-flex flex-wrap align-items-center details_boxed__price_amount">
                                            <div class="details_boxed__prices">
                                                ...
                                                {if $product->variant->price>0 && $product->variant->compare_price>0 && $product->variant->compare_price>$product->variant->price}
                                                    <div class="fn_discount_wrapper">
                                                        {$lang->product_discount_label}:
                                                        <b>
                                                            {$product->variant->compare_price-$product->variant->price}
                                                            {$currency->sign|escape}
                                                            ({round((($product->variant->compare_price-$product->variant->price)/$product->variant->compare_price)*100, 2)}&nbsp;%)
                                                        </b>
                                        ...
                                        <div class="d-flex align-items-center details_boxed__buttons">
                                            ...
                                            {else}
                                                ...
                                                <div class="fn_is_preorder {if $product->variant->stock > 0} hidden-xs-up{/if}">
                                                    ...
                                                    <button
                                                        class="fn_fast_order_button fast_order_button product-page__button product-page__button--preloader"
                                                        type="button" data-language="fast_order"
                                                        data-name="{$h1|escape}">{$lang->product_pre_order}</button>
                                                </div>
                                            {/if}
                                            ...
                                            {* Privat BTN *}
                                            <div
                                                class="fn_is_stock privat_oplata_chastynamy_btn hidden {if $product->variant->stock < 1} hidden-xs-up{/if}">
                                                <button class=" product-page__button button--blick" type="submit"
                                                    data-language="product_add_cart">
                                                    {$lang->privat_pp_title}
                                                    <br>
                                                    <span>
                                                        {$lang->order_text_of} <span class="privat_oplata_chastynamy">0</span>
                                                        {$currency->sign|escape} в {$lang->privat_title_3}
                                                    </span>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center details_boxed__other">
                                        ...
                                        {if is_array($wishlist->ids) && in_array($product->id, $wishlist->ids)}
                                            <a href="#" data-id="{$product->id}" class="fn_wishlist product-page__wishlist selected"
                                        ...
                                        {else}
                                            <a class="fn_comparison product-page__compare" href="#" data-id="{$product->id}"
                                                ...
                                                <i class="fa fa-balance-scale"></i>
                                                {$lang->product_add_comparison}
                                            </a>
                                        {/if}
                                    </div>

                                    <div class="exchange_return_label">
                                        {$lang->product_exchange_return_label}
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            {$banner_shortcode_product_advantages}
                ...
                <nav>
                    <ol class="pager row">
                        <li class="col-xs-12{if $next_product} col-sm-6{else} col-sm-12{/if}">
                            {if $prev_product}
                                <a class="d-flex align-items-center justify-content-center"
                                    href="{url_generator route="product" url=$prev_product->url}">
                        ...
                        <li class="col-xs-12 col-sm-6">
                            {if $next_product}
                                <a class="d-flex align-items-center justify-content-center"
                                    href="{url_generator route="product" url=$next_product->url}">
